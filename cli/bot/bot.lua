...
chats = {}
plugins = {}
MaTaDoR_sudo = 408594640 --> اینجا آیدی سودو اصلی رو جایگزین کنید
GpsidSudo = -1001263142243 --> اینجا آیدی پیوی یا گروه یا حتی چنل مورد نظرتونو جایگزین کنید تا هرجا ربات نصب میشه پیام اطلاع رسانی نصب در گروه جدید رو اینجا بده
bot_id =  498492871 --> جایگزین کنید cli اینجام که آیدی ربات
helper_id =  541383866--> جایگزین کنید api آیدی ربات
MaTaDoRch = '@Heart_Search' --> یوزرنیم کانالتونو جایگزین کنید
MaTaDoRby = '@EndLessGod' --> یوزرنیم خودتونو جایگزین کنید
MaTaDoRbybot = '@EndLessGod_Bot'  --> اگه پیام رسان دارید یوزرنیم پیام رسانتو جایگزین کنید 
paypinglink = '' --> یوزرنیم درگاه پرداخت پی پینگ هم اگه دارین وارد کنید
paypingname = '' --> اسم یا لقبی که می خواین لینک بشه به درگاه پرداخت رو وارد کنید
...
sudo_users = {408594640,498492871,541383866}, --> رو جایگزین کنید api و cli داخل آکولاد آیدی سودو اصلی و سودوهای دیگه (درصورت نیاز) و آیدی ربات
    admins = {},
    disabled_channels = {},
