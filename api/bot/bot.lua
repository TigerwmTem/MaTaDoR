...
bot_token = "541383866:AAFx7O0CbN7MA7Xo8a0OotbRbO-6JYL9aZ0" --> رو که در بات فادر ساختین جایگزین کنید api اینجا توکن ربات
send_api = "https://api.telegram.org/bot"..bot_token
sudo_id = 408594640 --> اینجا آیدی سودو اصلی رو جایگزین کنید
MaTaDoRch = '@Heart_Search' --> یوزرنیم کانالتونو جایگزین کنید
MaTaDoRby = '@EndLessGod' --> یوزرنیم سودو اصلی رو جایگزین کنید
require('./bot/methods')
require('./bot/utils')
require('./libs/JSON')
